...
export default function Shipping() {
  return (
    <div className="signincenter-container">
      ...
      <section className="signincenter-section freshness-section">
        <img
